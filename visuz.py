...
def volcano(table="dataset_file", lfc="logFC", pv="p_values", lfc_thr=1, pv_thr=0.05, color=("green", "red"), valpha=1,
            geneid=None, genenames=None, gfont=4):
    # load csv data file
    ...
    plt.xlabel('log2 Fold Change', fontsize=9, fontname="sans-serif", fontweight="bold")
    plt.ylabel('-log10(P-value)', fontsize=9, fontname="sans-serif", fontweight="bold")
    
    plt.xticks(np.arange(0,5,0.5), fontsize=10, fontname="sans-serif")
